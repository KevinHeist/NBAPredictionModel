...
# Creates new dict with Home/Away teams and the scores
# Taking in kaggle excel sheet ('games.csv') and outputting a new dict which was exported 
# to an excel sheet that is 'newGames.csv' used in ScoreCreation.py
# newGames.csv is an unordered excel sheet
